...
image_bandeira = Image.open(file1)
image_mapa = Image.open(file2)
image_bonito = Image.open(file3)
imagem_campo_grande = Image.open(file4)
imagem_corumba = Image.open(file5)
imagem_boiada = Image.open(file6)

tabela_pib = pd.read_excel('C:/dev/UDESC/ms_vs_co/assets/xls/tabela.xlsx', 'Produto Interno Bruto 2007')
tabela_pop = pd.read_excel('C:/dev/UDESC/ms_vs_co/assets/xls/tabela.xlsx', 'População Domicílios Censo 2000')
tabela_pec = pd.read_excel('C:/dev/UDESC/ms_vs_co/assets/xls/tabela.xlsx', 'Pecuária 2008')
tabela_agro = pd.read_excel('C:/dev/UDESC/ms_vs_co/assets/xls/tabela.xlsx', 'Produção Agrícola 2007')
